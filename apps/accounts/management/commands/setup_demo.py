...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if Flight.objects.count() == 0:
            ...
            flights = [
                ('XF001', '香港国际机场', '东京羽田机场', '2026-06-10 08:00', '2026-06-10 12:00', 'Boeing 787-10', 'international'),
                ('XF002', '香港国际机场', '北京首都机场', '2026-06-10 14:00', '2026-06-10 16:30', 'Boeing 737-800', 'domestic'),
                ('XF003', '香港国际机场', '新加坡樟宜机场', '2026-06-11 09:00', '2026-06-11 14:00', 'Airbus 350-900', 'international'),
                ('XF004', '香港国际机场', '上海浦东机场', '2026-06-11 16:00', '2026-06-11 18:00', 'Boeing 737-800', 'domestic'),
                ('XF005', '香港国际机场', '伦敦希思罗机场', '2026-06-12 10:00', '2026-06-12 23:00', 'Boeing 787-10', 'international'),
            ]
